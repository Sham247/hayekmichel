<?php
	...
	define("EZSQL_DB_USER", "monocledev");				// <-- mysql db user
	define("EZSQL_DB_PASSWORD", "root");			// <-- mysql db password
	define("EZSQL_DB_NAME", "root");				// <-- mysql db name
	define("EZSQL_DB_HOST", "127.0.0.1");		// <-- mysql server host
	// ==================================================================
	//	ezSQL Constants
	define("EZSQL_VERSION","1.22");
