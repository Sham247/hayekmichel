    ...
    angular.module("app.chart.ctrls", []).controller("chartCtrl", ["$scope", function($scope) {
        ...
        return $scope.mainData = [{
            ...
            $scope.donutData = [{
                    ...
                    label: "Rx Claims Value",
                    value: 2371097.82
                }
                // {label:"Mail-Order Sales",value:20},
                // {label:"Online Referrals",value:19}
            ]
    }]).controller("flotChartCtrl", ["$scope", function($scope) {
        var areaChart, barChart;
        return areaChart = {},
            areaChart.data1 = [
                [2005, 954086.169999999],
                [2006, 177437.91],
                [2007, 234460.19],
                [2008, 161103.49],
                [2009, 158784.28],
            ...
            $scope.barChart.options = {
                ...
                colors: ["#23AE89", "#2EC1CC", "#FFB61C", "#E94B3B", "#A74442", "#87A34C", "#70568D", "#4095AD", "#D7813C", "#91A7CD"]
            },
            $scope.pieChart = {},
            $scope.pieChart.data = [{
                label: "Hypertension	",
            ...
            $scope.pieChart2.data = [{
                ...
                label: "Supplies and Drugs",
                data: 808924.16
            }],
            $scope.pieChart2.options = {
                series: {
                    pie: {
                        show: !0
                    }
                ...
                colors: ["#4E7FBB", "#BD4E4C", "#99B958", "#7E629F", "#4AA9C3", "#F39344", "#2A4C74"],
                tooltip: !0,
                tooltipOpts: {
                    content: "%p.0%, %s",
                    defaultTheme: !1
            ...
            $scope.donutChart.data = [{
                ...
                label: "Acute Sinusitis NOS",
                data: 238
            }, {
                label: "Unspecified otitis media ",
                data: 136
            }, {
                label: "Vaginitis and vulvovaginitis, unspecified",
                data: 115
            }, {
                label: "Hematuria",
                data: 101
            ...
            $scope.donutChart.options = {
                ...
                colors: ["#44D0FF", "#FFE6C0", "#A4DA7D", "#76DCD9", "#D8F41B", "#FFE6C0", "#B6795C", "#FFBA9F", "#FBC21B", "#3597F8"],
                tooltip: !0,
                tooltipOpts: {
                    content: "%p.0%, %s",
                    defaultTheme: !1
            ...
            $scope.donutChart2.data = [{
                label: "Intra System Referrals",
                data: 30
            }, {
                label: "Online Referrals",
                data: 19
            }, {
        ...
        angular.module("app", ["ngRoute", "ngAnimate", "ui.bootstrap", "easypiechart", "mgo-angular-wizard", "textAngular", "app.ui.ctrls", "app.ui.directives", "app.ui.services", "app.controllers", "app.directives", "app.form.validation", "app.ui.form.ctrls", "app.ui.form.directives", "app.tables", "app.task", "app.localization", "app.chart.ctrls", "app.chart.directives"]).config(["$routeProvider",
            function($routeProvider) {
                return $routeProvider.when("/", {
                    ...
                    .when("/dashboard", {
                        templateUrl: "http://192.168.10.116/monocle_v7/display_state_dashboard.php"
                    })
                    .when("/user_dashboard", {
